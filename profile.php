...
<html>
    ...
    <body>
        ...
        <div class="col-lg-12">
           ...
           ?>
            <a href="changePass.php" class="btn btn-danger" role="button">Promena lozinke</a>
            <form action="" method="POST">
            <div class="form-group">
                <label for="usr">Ime:</label>
                <input value="<?=$user->korisnik_ime?>" type="text" name="name" class="form-control" id="usr">
            </div>
                
            <div class="form-group">
                <label for="usr">Prezime:</label>
                <input value="<?=$user->korisnik_prezime?>" type="text" name="surname" class="form-control" id="usr">
            </div>
                
            <div class="form-group">
                <label for="usr">E-mail adresa:</label>
                <input value="<?=$user->korisnik_email?>" type="text" name="email" class="form-control" id="usr">
            </div>
                
            <div class="form-group">
                <label for="usr">Kontakt telefon:</label>
                <input value="<?=$user->korisnik_kontakt?>" type="text" name="contact" class="form-control" id="usr">
            </div>
                
            <div class="form-group">
                <label for="usr">Adresa:</label>
                <input value="<?=$user->korisnik_adresa?>" type="text" name="address" class="form-control" id="usr">
            </div>
            
            <div class="form-group">
                <label for="usr">Grad:</label>
                <input value="<?=$user->korisnik_grad?>" type="text" name="city" class="form-control" id="usr">
            </div>
